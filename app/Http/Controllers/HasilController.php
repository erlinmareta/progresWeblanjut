...
class HasilController extends Controller
{
    ...
    {
        $data['dtHasil'] = DB::table('medicalcheckup')->join('detail_pasien', 'detail_pasien.id', '=', 'medicalcheckup.iddetail')->join('users',
        'detail_pasien.idpasien','=','users.id')->join('pakets', 'pakets.id', '=', 'detail_pasien.idpaket')->get();
