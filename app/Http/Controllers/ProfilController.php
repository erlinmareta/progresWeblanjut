...
class ProfilController extends Controller
{
    ...
    {
        $user = Hasil::join('detail_pasien', 'detail_pasien.id', '=', 'medicalcheckup.iddetail')->join('users','users.id','=','detail_pasien.idpasien')->join('pakets','pakets.id','=','detail_pasien.idpaket')->where('users.id','=',$id)->get();
